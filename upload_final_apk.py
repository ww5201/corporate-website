...
# Set CURRENT_VERSION=3 on server so this version matches
# Version 3 is already on server from previous update
# No need to change versionCode - current server versionCode=3 matches APK CURRENT_VERSION=3
